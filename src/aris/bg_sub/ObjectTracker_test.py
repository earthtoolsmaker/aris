...
class TrackerTest(unittest.TestCase):
    ...
    def __build_tracker(self):
        ...
        return ObjectTracker(
            radius, self.__build_BgFrame(), self.json_formatter, history=10
        )
    ...
    def test_track_and_return_updated_frame_same_objects(self):
        ...
        self.assertEqual(
            updated_frame.get_object(1).get_id(), base_frame[0].get_object(1).get_id()
        )
        self.assertEqual(
            updated_frame.get_object(1).get_xywh(),
    ...
    def test_track_and_return_updated_frame_different_objects(self):
        ...
        self.assertEqual(
            updated_frame.get_object(0).get_xywh(),
            updating_frame.get_object(2).get_xywh(),
        )
